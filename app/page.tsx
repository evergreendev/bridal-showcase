    ...
    return (
        <div>
            ...
            <section className="relative overflow-hidden bg-gradient-to-b from-white to-pink-100">
                <div
                    className="max-w-6xl mx-auto px-4 py-24 sm:py-12 flex flex-col items-center justify-center text-center">
                    ...
                    <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
                        <a href="#dates"
                           className="px-6 py-3 rounded-full bg-pink-600 text-white font-medium shadow hover:bg-pink-700">See
                            Dates</a>
                        <a href={TICKET_URL} target="_blank" rel="noopener noreferrer"
                           className="px-6 py-3 rounded-full border border-pink-300 text-pink-700 font-medium hover:border-pink-400 hover:bg-white">Buy
                            Tickets</a>
                    </div>
                </div>
                ...
                <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div>
                        ...
                        <div className="mt-4 space-y-4 text-zinc-700 max-w-prose">
                            <p>The 2026 Bridal Showcase in Rapid City gives brides-to-be and grooms the opportunity to
                                meet the professionals who help make their event memorable. This annual event features
                                photographers, florists, DJs, hotel and reception facility coordinators, jewelry
                                professionals, wedding planners and officiants, beauty and makeup experts, and more.</p>
                            <p>Whether you&#39;re planning your wedding or organizing a special event, the Bridal
                                Showcase professionals can customize your experience to ensure your special day is
                                anything but ordinary!</p>
                        </div>
                        <div className="mt-8">
                            <h3 className="text-xl font-semibold text-pink-800">Event Date & Location</h3>
                            <p className="mt-2 text-zinc-700">Plan to attend the <strong>49th Annual Bridal
                                Showcase</strong> on <strong>Saturday, January 3, 2026</strong>, at the <strong>Best
                                Western Ramkota Hotel and Conference Center</strong> in Rapid City, SD.</p>
                            <a href={TICKET_URL} target="_blank" rel="noopener noreferrer"
                               className="mt-4 inline-block px-5 py-2.5 rounded-full bg-pink-600 text-white font-medium hover:bg-pink-700">Get
                                Tickets</a>
                        </div>
                    </div>
                </div>
            ...
            <section id="tickets" className="scroll-mt-24 bg-pink-50/100 border-y border-pink-200">
                <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    <div>
                        <h2 className="text-3xl font-semibold text-pink-800">Ticket Prices:</h2>
                        <div className="mt-4 text-zinc-700 max-w-prose space-y-3 md:space-y-4 leading-relaxed">
                            <p className="font-bold">General Admission ticket <strong>$5.00</strong></p>
                            ...
                            <p>VIP Admission ticket <strong>$14.00</strong></p>

                            <p>Includes one admission ticket, one drink ticket and one reserved seating card for front
                                row at the 1:00 PM Runway Fashion Show.</p>

                            <p>(VIP tickets are limited to the first 50 ticket holders)</p>

                            <p>First 30 Bride and Groom to register and purchase any online tickets will be given a
                                Bride and Groom Luggage Tag Set at the door day of show.</p>

                            <p>Tickets available at the door <strong>$7.50</strong> (Cash or Check Only)</p>

                            <p>First 75 Brides in the door day of show receive a Rhinestone/Pearl or Glitter Bridal
                                Sash</p>
                        </div>
                        <a href={TICKET_URL} target="_blank" rel="noopener noreferrer"
                           className="mt-6 inline-block px-6 py-3 rounded-full bg-pink-600 text-white font-medium shadow hover:bg-pink-700">Get
                            Tickets on Eventbrite</a>
                    </div>
                    <Image src={gallery[2]} alt="Tickets and registration"
                           className="w-full h-auto lg:max-w-md mx-auto rounded-2xl shadow ring-1 ring-pink-200 bg-pink-50"/>
                </div>
            </section>
            ...
            <section id="fashion" className="bg-white">
                <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    <Image src={gallery[3]} alt="Runway and prizes highlights"
                           className="w-full h-auto lg:max-w-md mx-auto rounded-2xl shadow ring-1 ring-pink-200 bg-pink-50"/>
                    <div>
                        <h2 className="text-3xl font-semibold text-pink-800">Highlights: Fashion Show & Prizes</h2>
                        <div className="mt-4 space-y-4 text-zinc-700 max-w-prose">
                            <p><strong>Fashion Show at Noon and 3 PM</strong> — Be inspired by the latest bridal attire
                                as it takes the runway.</p>
                            <div>
                                <p className="font-semibold text-pink-800">Prizes & Giveaways</p>
                                <ul className="mt-2 space-y-2 list-disc pl-5">
                                    <li>Bride&#39;s — register for the <strong>$750 gift certificate</strong> from
                                        Riddle&#39;s Jewelry.
                                    </li>
                                    <li>Grooms — register at the door for a <strong>50&quot; LED 4K Smart Fire
                                        TV</strong>. <em>(Must be present to win)</em></li>
                                </ul>
            ...
            <section className="bg-white">
                <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 items-start">
                    <div>
                        ...
                        <p className="mt-4 text-zinc-700 max-w-prose">A glimpse of the romance and inspiration you can
                            expect at the Bridal Showcase.</p>
                        <div
                            className="mt-6 aspect-video rounded-2xl overflow-hidden shadow ring-1 ring-pink-200 bg-pink-100">
            ...
            <section id="contact" className="scroll-mt-24 bg-white hidden">
                <div className="max-w-6xl mx-auto px-4 py-16 grid lg:grid-cols-2 gap-10">
                    <div>
                        ...
                        <p className="mt-4 text-zinc-700">Have questions or want to become a vendor? Send us a
                            message.</p>
                        <div className="mt-6 text-zinc-700">
                            <p>Email: <a className="text-pink-700 underline"
                                         href="mailto:info@bridalshowcase.local">info@bridalshowcase.local</a></p>
                        </div>
                    </div>
